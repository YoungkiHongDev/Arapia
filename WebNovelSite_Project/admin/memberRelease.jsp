...
<table width="60%" align="center" bgcolor="#FFFF99">
	...
	<td align="center" bgcolor="#FFFFCC">
		...
		<td align="center"><font color="#FFFFFF">삭제</font></td>
		</tr>
		<%
		...
		<td align="center"><a href="javascript:Delete('<%=resBean.getResid()%>')">삭제하기</a></td>
		<%}%>
		</table>
...
<form name="delete" method="post" action="memberDelete.jsp">
